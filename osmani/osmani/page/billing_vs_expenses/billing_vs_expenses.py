...
@frappe.whitelist()
def get_gl_entries_for_projects(from_date, to_date, projects=None):
	"""
	Get GL Entries with root_type for billing vs expenses report
	...
	# SQL query - same as Profitability Analysis (line 216-229)
	query = f"""
		SELECT 
			posting_date,
			project,
